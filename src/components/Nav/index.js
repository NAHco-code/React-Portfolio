        ...
        <div className="sticky">
            <div className="title-bar nav">
                ...
                <div className="title-bar-right nav-sec nav-3">
                    ...
                    <a href='https://twitter.com/NAHco_code' target='_blank' rel='noreferrer' className='nav-icon-links'>
                        <img alt='' className='nav-icons' src={twitterIcon} />
                    </a>
                    <a href='https://www.linkedin.com/in/kwilkinsonxx/' target='_blank' rel='noreferrer' className='nav-icon-links'>
                        <img alt='' className='nav-icons' src={linkedinIcon} />
                    </a>
                    <a href='https://github.com/NAHco-code' target='_blank' rel='noreferrer' className='nav-icon-links'>
                        <img alt='' className='nav-icons' src={githubIcon} />
                    </a>
                    <a href='https://www.instagram.com/nahco_code/' target='_blank' rel='noreferrer' className='nav-icon-links'>
